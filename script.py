class script(object):
    START_TXT = """𝙷𝙴𝙻𝙾 {},
𝙼𝚈 𝙽𝙰𝙼𝙴 𝙸𝚂 <a href=https://t.me/{}>{}</a>, 𝙃𝙊𝙒 𝘾𝘼𝙉 𝙄 𝙃𝙀𝙇𝙋 𝙔𝙊𝙐, 𝙏𝙃𝙄𝙎 𝘽𝙊𝙏 𝙄𝙎 𝘾𝙊𝙈𝙋𝙇𝙀𝙏𝙀𝙇𝙔 𝙈𝘼𝘿𝙀 𝘽𝙔 𝙏𝙀𝘼𝙈 𝙎𝘼𝙉𝙐𝙎𝙈𝙊𝙑𝙄𝙀𝙎 🎭 """
    HELP_TXT = """𝙷𝙴𝚈 {}
...
✯ 𝙱𝚄𝙸𝙻𝙳 𝚂𝚃𝙰𝚃𝚄𝚂: v2.0.2 [ 𝙱𝙴𝚃𝙰 ]"""
    SOURCE_TXT = """<b>ᴺᴼᵀᴱ:</b>
- <a href='@Lucifer_filter_bot'>LUCIFER</a> Is Not A Oᴘᴇɴ Sᴏᴜʀᴄᴇ Pʀᴏᴊᴇᴄᴛ.  
- Group - <a href='https://t.me/MOVIEBRANTHANZGROUP'>Cʟɪᴄᴋ Mᴇ</a>

<b>Channel:</b>
- <a href=https://t.me/kunjappansupportez>SUPPORT BOTZ</a>"""
