...
async def start(client, message):
    if message.chat.type in ['group', 'supergroup']:
        buttons = [
            [
                InlineKeyboardButton('☃︎𝕲𝕽𝕺𝖀𝕻☃︎', url='https://t.me/MOVIEBRANTHANZGROUP')
            ],
            [
                InlineKeyboardButton('🥺 Hᴇʟᴘ', url=f"https://t.me/PSY_OF_TG"),
            ]
            ]
        reply_markup = InlineKeyboardMarkup(buttons)
        await message.reply(script.START_TXT.format(message.from_user.mention if message.from_user else message.chat.title, temp.U_NAME, temp.B_NAME), reply_markup=reply_markup)
        await asyncio.sleep(2) # 😢 https://github.com/hopepsycho/kunjappan2.0/blob/master/plugins/p_ttishow.py#L17 😬 wait a bit, before checking.
    ...
    if len(message.command) != 2:
        buttons = [[
            ...
            InlineKeyboardButton('꧁ՏᑌᑭᑭOᖇT꧂', url='https://t.me/kunjappansupportez'),
            InlineKeyboardButton('𖠌ɢʀᴏᴜᴘ𖠌', url='https://t.me/MOVIEBRANTHANZGROUP'),
            ],[
